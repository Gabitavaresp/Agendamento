...
$stmc = $pdo->query("SELECT * FROM cliente");
			...
			<div class="form">
				...
				<select name="cliente" id='cliente'>
					...
					<?php foreach ($rcli as $c) { ?>
						<option value="<?php echo $c['idcliente'];?>"><?php echo $c['nome_cliente'];?></option>
					<?php }?>
				</select>
			</div>
				<div class="form">
...
var_dump($_POST);
	...
	$stagenda = $pdo->prepare("UPDATE agenda SET cliente = :c, status_agendamento = :s WHERE idagendamento = :ho");
